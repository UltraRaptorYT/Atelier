...
export async function snapshot(env: Bindings, row: ProjectRow): Promise<Snapshot> {
  const [design, tasks, events, artifacts, images, runs, changes] = await Promise.all([
